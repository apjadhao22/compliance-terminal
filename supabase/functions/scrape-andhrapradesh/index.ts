// Supabase Edge Function: scrape-andhrapradesh
// Scraper for Andhra Pradesh Gazette
...
async function scrapeAndhraPradesh() {
  const browser = await playwright.chromium.launch();
  const page = await browser.newPage();
  await page.goto('https://apegazette.cgg.gov.in/');
