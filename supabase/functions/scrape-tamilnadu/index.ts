// Supabase Edge Function: scrape-tamilnadu
// Scraper for Tamil Nadu e-Gazette
...
async function scrapeTamilNadu() {
  const browser = await playwright.chromium.launch();
  const page = await browser.newPage();
  await page.goto('https://www.tn.gov.in/gazette/');
