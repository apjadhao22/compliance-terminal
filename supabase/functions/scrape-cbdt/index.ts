// Supabase Edge Function: scrape-cbdt
// Scraper for CBDT / Income Tax (incometaxindia.gov.in)
...
async function scrapeCBDT() {
  const browser = await playwright.chromium.launch();
  const page = await browser.newPage();
  await page.goto('https://www.incometaxindia.gov.in/');
