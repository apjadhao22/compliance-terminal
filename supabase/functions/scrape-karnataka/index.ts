// Supabase Edge Function: scrape-karnataka
// Scraper for Karnataka (gazette.kar.nic.in, Karnataka Labour Dept)
...
async function scrapeKarnataka() {
  const browser = await playwright.chromium.launch();
  const page = await browser.newPage();
  await page.goto('https://gazette.kar.nic.in/');
