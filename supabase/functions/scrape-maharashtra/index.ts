// Supabase Edge Function: scrape-maharashtra
// Scraper for Maharashtra (maharashtra.gov.in, Maharashtra Labour Dept)
...
async function scrapeMaharashtra() {
  const browser = await playwright.chromium.launch();
  const page = await browser.newPage();
  await page.goto('https://www.maharashtra.gov.in/');
